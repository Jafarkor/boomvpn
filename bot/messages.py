...
def welcome_new(name: str) -> str:
    ...
    return (
        ...
        f"Ссылку подписки и инструкцию по подключению найдёшь в главном меню 👇"
    )
...
def sub_url_text(url: str) -> str:
    return (
        "<i>Нажми на ссылку (она скопируется), "
        "затем вставь её в своё VPN‑приложение по инструкции.</i>\n\n"
        "────────────────\n"
        f"<code>{url}</code>\n"
        "────────────────\n\n"
