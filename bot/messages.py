...
def welcome_new(name: str) -> str:
    ...
    return (
        ...
        f"Чтобы подключить VPN, подпишись на наш канал <b>↓</b>"
    )
...
def welcome_new_no_sub(name: str) -> str:
    ...
    return (
        ...
        f"Но сначала — подпишись на наш канал <b>↓</b>"
    )
...
def settings_text(sub: dict) -> str:
    ...
    return (
        ...
        f"<i>{'Подписка продлится автоматически.' if auto else 'Подписка не продлится автоматически. Продли вручную.'}</i>\n\n"
...
# ── Напоминания о подписке (автоворонка) ─────────────────────────────────────

def reminder_expiring_soon_text() -> str:
    """За ~24 часа до окончания — нет автопродления или нет метода оплаты."""
    return (
...
def reminder_just_expired_text() -> str:
